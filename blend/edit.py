...
#shadow_tone_percent [0.0 ~ 1.0]: Controls the range of tones in the shadows or highlights that are modified.
...
#highlight_tone_percent [0.0 ~ 1.0]: Controls the range of tones in the shadows or highlights that are modified.
#highlight_radius [>0]: Controls the size of the local neighborhood around each pixel
#color_percent [-1.0 ~ 1.0]:
