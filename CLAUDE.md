...
4. Verify mirrors against the running app using the DEBUG launch hooks (`LL_TAB`, `LL_OPEN`, `LL_SEED`, `LL_DETAIL`, `LL_PUSH`, `LL_CAPTURE`, `LL_BURST`, `LL_SPEED`, `LL_AUTO`, `LL_VIEWER`) via `simctl launch`.
